  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-4xl px-6 sm:px-8 text-center">
        ...
        >
          <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-serif font-bold tracking-tight text-foreground">
            {" "}
            {/* Adjusted font sizes */}
            Shashank.
          </h1>
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-serif font-bold tracking-tight text-secondary sm:text-nowrap">
            {" "}
            {/* Adjusted font sizes */}I build things for the web.
          </h2>
        </motion.div>
        {/* Bio text */}
        <motion.div
        ...
        >
          <p className="text-lg md:text-xl lg:text-2xl font-sans text-foreground/80">
            I'm a software engineer with backend experience in Ruby on Rails,
            building APIs, improving performance, and shipping reliable
            full-stack products.
          </p>
        </motion.div>
